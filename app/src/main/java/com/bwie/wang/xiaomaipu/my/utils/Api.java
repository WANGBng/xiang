...
//详情
    ...
    Observable<ProFragmentBean> queryGoodsByPid(@Query("commodityId")int commodityId);

//    查询购物车

    @GET("order/verify/v1/findShoppingCart?userId=18&sessionId=15320748258726")
...
//    同步购物车
    ...
    Observable<SyncShoppingBean> getSyncShoppingBea(@Query("commodityId") int commodityId, @Query("count")int count);
